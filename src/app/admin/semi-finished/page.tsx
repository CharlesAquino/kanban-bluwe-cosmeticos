  ...
  return (
    <div className="container mx-auto p-6 max-w-3xl">
      ...
      <div className="text-center space-y-4 mb-6">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg">
          <PlusCircle className="h-8 w-8" />
        </div>
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Administração – Categorias de Semi-Acabados</h1>
